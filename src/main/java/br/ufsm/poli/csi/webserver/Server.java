...
public class Server {
    ...
    public static Reserva getReservaByPoltronaId(int id) {
        ...
        Optional<Reserva> optionalReserva = reservas.stream()
                .filter(reserva -> reserva.getPoltrona().getId() == id)
                .findFirst();
        ...
        while (true) {
            ...
            if (recurso.equals("/")) {
                ...
                if (reserva != null) {
                    ...
                    System.out.println("Nome: " + reserva.getNomeReservante());
                    System.out.println("ID da Poltrona: " + reserva.getPoltrona().getId());
                    System.out.println("Data da Reserva: " + reserva.getDataReserva());
                    System.out.println("Reservada: " + reserva.getPoltrona().isReservada());
            ...
            if (getContentType(recurso) == "text/html") {
